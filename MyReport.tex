...
\title{I hope i get an A+ in this class}
\author{ Cherif}
\date{\today}
...
\iknow{cp}{copy file }
\iknow{cp -r}{copy file or directory}
\iknow{mv}{rename}
\iknow{rm}{delete}
\iknow{rm -r}{delete multiple}
\iknow{ls -a}{show hidden}
\iknow{ls -al}{show hidden and owner}
\iknow{ls -l}{show description}
\iknow{ssh}{secure shell}
\iknow{ssh-keygen}{generate ssh key}
\iknow{cd}{change directory}
\iknow{cd ../}{back directory}
\iknow{cd \textasciitilde}}
\iknow{echo}{create file and modify}
\iknow{cat}{read content}
\iknow{adduser}{add a user}
\iknow{deluser}{delete user}
\iknow{chmod}{change mode rwx}
\iknow{chown}{change owner}
